...
/**
 * Configures alertas and exceptions handlers.
 *
...
class DebugHandlersListener implements EventSubscriberInterface
{
     ...
     * @param int|null             $throwAt          Thrown alertas in a bit field of E_* constants, or null to keep the current value
     * @param bool                 $scream           Enables/disables screaming mode, where even silenced alertas are logged
