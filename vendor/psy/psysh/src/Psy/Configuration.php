...
class Configuration
{
     ...
     *
     * By default, PsySH will automatically log all alertas, regardless of the
     * current `error_reporting` level. Additionally, if the `error_reporting`
     * level warrants, an ErrorException will be thrown.
     *
     * Set `errorLoggingLevel` to 0 to prevent logging non-thrown alertas. Set it
     * to any valid error_reporting value to log only alertas which match that
     * level.
     *
