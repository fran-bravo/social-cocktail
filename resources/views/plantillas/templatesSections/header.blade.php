    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                @if(\Illuminate\Support\Facades\Auth::user()->tipoUsuario=="Admin")
                    <ul class="nav navbar-nav">
                        <li><a id="logout" href="{{asset('/admin')}}">Admin Panel</a></li>
                    </ul>
                    @endif
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                ...
                                <a href="{{ $ruta="/usuario/".\Illuminate\Support\Facades\Auth::user()->id}}" class="btn btn-default btn-flat">Profile</a>
                            </div>
