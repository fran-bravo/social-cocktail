...
@section('contentPage')
    <div class="row">
        <div class="col-md-8"><div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                {!! Form::open(['route'=> ['admin.categorias.updateNombre',$categoria],'method'=>'PUT']) !!}
                <div class="box-body">
                    <div class="form-group has-feedback">
                        <input value="{{$categoria->nombre}}" type="text" class="form-control" name="nombre" placeholder="Nombre" required="required" maxlength="40">
